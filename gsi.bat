...
set splash_base=gsi-base-splash.png
set icon_base=gsi-base-icon.png
set background=#FFFFFF

set convert=convert %splash_base% -background %background% -gravity center
...
set icons=convert %icon_base% -background transparent
